...
class HelpSupport:
    ...
    def create_widgets(self):
        ...
        # Help Icon
        icon_path = "path/to/help_icon.png"  # Add path to your help icon image
        ...
        # Tabs for Guided Tutorials, Knowledge Base, and Support Contact
        self.notebook = ttk.Notebook(self.frame)
        self.notebook.pack(pady=5, fill=tk.BOTH, expand=True)

        # Guided Tutorials Tab
    ...
    def show_help(self):
        # Show help information or open help documentation
        messagebox.showinfo("Help", "Help documentation and tutorials will be provided here.")

    def search_knowledge_base(self):
        # Perform search operation in the knowledge base
