...
class Timeline:
    ...
    def create_widgets(self):
        ...
        # Bind event for clicking on timeline events
    ...
    def draw_timeline(self):
        ...
        # Draw timeline events with color-coded markers
        self.event_ids = []
        ...
        # Set canvas width to fit all events and allow scrolling
    ...
    def zoom_timeline(self, zoom_value):
        ...
        self.timeline_canvas.scale("all", 0, 0, scale / 5.0, 1)  # Adjust scale factor as needed
        self.timeline_canvas.config(scrollregion=self.timeline_canvas.bbox("all"))
